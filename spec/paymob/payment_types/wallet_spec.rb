...
RSpec.describe Paymob::PaymentTypes::Wallet do
  describe '#initialize_order' do
    context 'when request a new payment with type wallet' do
      let(:payment) do
        described_class.new
      end
      ...
      it 'return payment key' do
        VCR.use_cassette('payment_creation') do
          ...
          uri = URI.parse(payment.payment_link(mobile_number: '01010101010'))
